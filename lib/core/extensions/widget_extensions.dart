...
extension WidgetExtension on Widget {
  ...
  Widget setAnimatedContainer({Duration? buration, double? width, double? hight}) {
  ...
  Widget setCustomConatinerShadow() {
    return Container(
      ...
      decoration: ShapeDecoration(
        ...
        shadows: const [
          BoxShadow(color: Color(0x1E000000), blurRadius: 8, offset: Offset(0, 0), spreadRadius: 0),
        ],
      ),
      child: this,
    );
  ...
  ///scrollable
  Widget scrollable({EdgeInsets? padding}) {
