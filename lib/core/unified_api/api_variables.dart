...
class ApiVariables {
  ...
  //////Auth End///////
  Uri deleteReply(int id) => _customerApi(path: 'contact-reply/delete/$id');
  Uri createReply() => _customerApi(path: 'contact-reply/create');
  Uri getReplies(int id, ParamsMap params) =>
      _customerApi(path: 'contact-reply/$id', params: params);
  Uri createTicket() => _customerApi(path: 'contact-us/create');
  Uri getTickets(ParamsMap params) =>
      _customerApi(path: 'contact-us', params: params);
  //////Countries Start///////
  ...
  //////Home Screen End///////
  //////Orders Start///////
  Uri createOrder() => _customerApi(path: 'orders/create');
  Uri indexOrders(ParamsMap params) =>
      _customerApi(path: 'orders', params: params);
  Uri showOrder(int id) => _customerApi(path: 'orders/show/$id');
  Uri showOrderItem(int id) => _customerApi(path: 'order-items/show/$id');
  Uri reviewService() => _customerApi(path: 'job-reviews/create');
  Uri reviewTechnician() => _customerApi(path: 'technician-reviews/create');
  Uri cancelOrder(int id) => _customerApi(path: 'orders/delete/$id');
  //////Orders  End///////
  //////Notifications  End///////
  Uri getNotifications(ParamsMap params) =>
      _customerApi(path: 'notifications', params: params);
  Uri readNotifications(int id) => _customerApi(path: 'notifications/read/$id');
  Uri readAllNotifications() => _customerApi(path: 'notifications/read-all');
  //////Notifications  End///////
  //////Others  Start///////
  Uri privacyPolicy() => _mainUri(path: 'pages/show/privacy-policy');
  Uri aboutUs() => _mainUri(path: 'settings/get');
  //////Others  End///////
}
